...
var amigos = [{ nombre: 'toni', edad: 33 }, { nombre: 'Emi', edad: 20 }, {nombre: 'Ana', edad: 18}, {nombre: 'Gina', edad: 29}];
console.log(buscarAmigo(amigos, 'toni')); 
console.log(buscarAmigo(amigos, 'Gina')); 
console.log(buscarAmigo(amigos, 'Lucas')); 
